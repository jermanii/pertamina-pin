...
{
    public partial class VwExportInitiative
    {
        ...
        public string PicMembers { get; set; }
        ...
        public string KementrianLembagaId { get; set; }
        public string KementrianLembaga { get; set; }
        public string LastMilestone { get; set; }
        public DateTime? LastDateMilestone { get; set; }
