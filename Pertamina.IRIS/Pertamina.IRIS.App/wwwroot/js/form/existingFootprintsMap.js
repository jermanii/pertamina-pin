am5.ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    polygonSeries.mapPolygons.template.events.on("click", function (ev) {
                        ...
                        $.ajax({
                            url: param.urlHighPriority + '?isHigh=' + false + '&isFilter=' + isFilter + '&isSort=' + false
                                + '&isScroll=' + false + '&isClickMap=' + true
                                + '&countryAcronym=' + dataContext.id + '&negara=' + negaraMitra + '&stream=' + streamBusiness + '&entitas=' + entitasPertamina
                        ...
                        $('.headerHighPriority').text("Clickable Map Exisiting Footprints");
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    polygonSeries.mapPolygons.template.events.on("click", function (ev) {
                        ...
                        $.ajax({
                            url: param.urlHighPriority + '?isHigh=' + false + '&isFilter=' + false + '&isSort=' + false
                                + '&isScroll=' + false + '&isClickMap=' + true
                                + '&countryAcronym=' + dataContext.id + '&negara=' + '&stream=' + '&entitas='
                                + '&category=' + '&order=' + '&pageCount=' + 1,
                            type: 'GET',
                            success: function (result) {
                                $("#HighPriorityView").html(result);
    ...
    $('#ddlNegaraMitra,#ddlStreamBusiness,#ddlEntitasPertamina').on('change', function (e) {
        ...
        if (negaraMitra == null && streamBusiness == null && entitasPertamina == null) {
            ...
            $('.headerHighPriority').text("Filter Exisiting Footprints");

            innerFunction(true, negaraMitra, streamBusiness, entitasPertamina);

            $.ajax({
                url: param.urlHighPriority + '?isHigh=' + false + '&isFilter=' + true + '&isSort=' + false
                    + '&isScroll=' + false + '&isClickMap=' + false
